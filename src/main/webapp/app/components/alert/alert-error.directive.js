(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('mdconfigApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-mdconfigApp-error');
                var entityKey = httpResponse.headers('X-mdconfigApp-params');
                if (errorHeader) {
